...
[![GitHub WidgetBox](https://github-widgetbox.vercel.app/api/skills?names=js,ts,java,php,python,html,css,c,cpp,kotlin,dart,xml,json,yaml,postgresql,mysql,powershell,sass,graphql,markdown)&includeName=true](https://github.com/Jurredr/github-widgetbox)
